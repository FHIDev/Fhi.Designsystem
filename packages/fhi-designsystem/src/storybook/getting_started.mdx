...
- [Designressurser](#designressurser)
  - [Figma](#figma)
  - [Retningslinjer for design](#retningslinjer-for-design)
  - [Ressurser](#ressurser)
...
Pakkene inneholder komponentene, en CSS-fil med våre design tokens og en tekststilfil for Roboto Flex fra Google Fonts. Roboto Flex er allerede tatt i bruk i komponentene og er gjort tilgjengelig gjennom en design token. 
 
> For info om intellisense og typesjekking [se her](/docs/ofte-stilte-spørsmål-typesjekking-intellisense--docs).
