...
**Typescript:** Bruker du typescript i React-prosjektet ditt, kan du oppleve at React ikke gjenkjenner webkomponentene. Dette er fordi de ikke enda er typesatt.
For å løse dette kan du legge til en global deklarasjon i prosjektet ditt. Legg til følgende type deklarasjon i prosjektet ditt:
