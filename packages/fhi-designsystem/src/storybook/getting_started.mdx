...
Nettleseren har innebygd støtte for web komponenter. Du kan derfor bruke komponentene direkte i HTML-filen din uten ekstra konfigurasjon. 

Under er et eksempel på hvordan du bruker en `fhi-button` i standard HTML/JS. Vi tar henhold i at du har brukt cdn da du installerte designsystem pakken.
