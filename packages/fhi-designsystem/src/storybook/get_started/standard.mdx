...
<Meta title="Kom i gang/Standard HTML og JS" />

# Standard HTML/JS

<Subtitle>Kom i gang med FHI Designsystem i ditt prosjekt</Subtitle>
...
**Merk:** Vi tar utgangspunkt i at du har brukt CDN for å installerte pakken.
