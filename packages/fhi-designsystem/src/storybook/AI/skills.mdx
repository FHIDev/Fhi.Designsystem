...
<a className="download-link" href="/SKILL.md" download="SKILL.md">
  Last ned SKILL.md
</a>

Skillen er testet med GPT 5.4 og Claude Sonnet 4.6.

Bruker du VSCode med Copilot, kan du plassere `SKILL.md`-filen i `.github/skills/fhi-designsystem/`. Da vil Copilot automatisk finne filen.
