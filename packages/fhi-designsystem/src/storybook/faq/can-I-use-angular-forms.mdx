...
For `form`-komponenter med `string` verdier, f.eks. `<fhi-text-input>` kan du bruke Angular sitt `ngDefaultControl` direktiv for å koble komponentene til Angular Forms.
