...
For webkomponenter med oppførsel på linje med `<input type="text">`, slik som `<fhi-text-input>`, kan du bruke Angular sitt `ngDefaultControl` direktiv for å koble komponentene til Angular Forms.
