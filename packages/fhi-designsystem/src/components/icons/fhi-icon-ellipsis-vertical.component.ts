  ...
  render() {
    return html`
      ...
      >
        <path
          fill-rule="evenodd"
          d="M12 6.75a1.75 1.75 0 1 0 0-3.5 1.75 1.75 0 0 0 0 3.5m0 7a1.75 1.75 0 1 0 0-3.5 1.75 1.75 0 0 0 0 3.5m0 7a1.75 1.75 0 1 0 0-3.5 1.75 1.75 0 0 0 0 3.5"
          clip-rule="evenodd"
        />
      </svg>
    `;
