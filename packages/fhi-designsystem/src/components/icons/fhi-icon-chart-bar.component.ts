...
export const FhiIconChartBarSelector = "fhi-icon-chart-bar";
 ...
 * 
 * @tag fhi-icon-chart-bar
 * @element fhi-icon-chart-bar
 */
@customElement(FhiIconChartBarSelector)
export class FhiIconChartBar extends LitElement {
