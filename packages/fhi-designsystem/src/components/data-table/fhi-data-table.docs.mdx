...
Gir du første rad `variant="header"`, vil cellene arve dette og få riktig overskriftstil.

<Canvas of={FhiDataTableStories.Simple} />

Bruk `striped` for å gi tabellen sebrastriper, noe som kan hjelpe brukernes øyne å følge radene. 

<Canvas of={FhiDataTableStories.ComplexData} />

Cellene kan inneholde alt slags innhold, som avkrysningsbokser, tagger og handlinger.  
