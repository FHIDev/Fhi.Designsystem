...
- **`small`** brukes når det er lite plass til knappen eller det kan bli overveldende med mange `mediun`-knapper i én gruppe
...
Ikon settes til venstre for teksten. I noen kontekster settes det til høyre, slik som handlinger som minner om retning (f.eks. “gå videre”, “neste side” og “flytt til høyre”) eller man åpner en nedtrekksmeny.
...
Her prøver vi å beskrive noen råd, tips og retningslinjer om bruk av knapper. 
...
Noen ganger er hovedformålet til en side å interagere med andre elementer eller presentere innhold, i stedet for å sette i gang en handling. I slike tilfeller kan en veldig sterk handlingsknapp (også kalt «Call to Action») vil konkurrere om oppmerksomheten fra selve hovedformålet. Vurdér andre varianter for sekundære handlinger.
