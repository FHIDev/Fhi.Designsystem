...
<div class="callout-warning">
  **Obs:** `icon-only`-attributten er nå **avviklet** og vil bli fjernet i fremtiden. Knappen oppdager nå om den kun inneholder et ikon selv og får riktig styling automatisk.
</div>
