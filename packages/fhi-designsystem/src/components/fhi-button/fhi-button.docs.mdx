...
#### Knapp med _kun_ ikon

<div class="callout-warning">
  **Obs:** `icon-only` attributten er nå **deprekert** og vil bli fjernet i fremtiden. Knappen vil nå automatisk detektere om den kun inneholder et ikon og vil bruke riktig styling.
</div>
